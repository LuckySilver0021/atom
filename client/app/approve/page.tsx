...
const Approval = () => {
    ...
    // Fix: Handle redirection inside useEffect to avoid rendering errors
    useEffect(() => {
    ...
    const handleDeny = async () => {
        ...
        try{
      toast.loading("Denying user...",{id:"loading"});
    ...
    // Prevent rendering UI if user is not authenticated (redirecting)
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            {isProcessing.approve ? (
                                ...
                                <><CheckCircle className="w-5 h-5" /><span>Approve Device</span></>
                            )}
                        </Button>
                        ...
                        >
                            {isProcessing.deny ? (
                                ...
                                <><XCircle className="w-5 h-5" /><span>Deny Device</span></>
                            )}
                        </Button>
                    </div>
